...
class HashTable {
public:
	HashTable(int size, double threshold=0.6, int methode=2); // Konstruktor !--NEU--!
...
private:	
	...
	int m_sondierMethode;				// Sondier Methode 1 - linear, 2 - quadratisch, 3 - doppeltes Hashing !--NEU--!
...
int get_last_Prime(int a);				// Gibt zu einer natuerlichen Zahl a, die naechstkleienre Primzahl zurueck !--NEU--!
#endif 